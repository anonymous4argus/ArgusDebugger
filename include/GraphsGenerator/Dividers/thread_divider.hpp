...
public:
	...
	DividerHelper()://backtrace_for_hook(nullptr),
...
public:
	//typedef std::unordered_map<uint64_t, Group*> groups_t;
	//typedef std::unordered_map<uint64_t, groups_t> divides_t;
...
public:
    RunLoopThreadDivider(int index, divides_t &sub_results, event_list_t &ev_list);//, bool no_observer_entry);
